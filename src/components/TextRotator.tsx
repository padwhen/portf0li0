  ...
  >
    ...
    I am a passionate Software Developer &
      ...
      >
        ...
        >
          <li className="text-[#2f7df4]">Life-Long Learner</li>
          <li className="text-[#2f7df4]">Student</li>
          <li className="text-[#2f7df4]">Tech Enthusiast</li>
          <li className="text-[#2f7df4]">Contributer</li>
          <li className="text-[#2f7df4]">Innovator</li>
          <li className="text-[#2f7df4]">Team Player</li>
        </ul>
      </span>
    </div>
  </div>
